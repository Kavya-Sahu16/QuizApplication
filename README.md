...
## 📌 How to Run
1. Open a terminal and navigate to the project root directory: cd "/Users/kavya/Documents/Quiz Application"
2. Compile all Java source files: javac src/*/*.java
3. Run the quiz application: java -cp src main.QuizGame
