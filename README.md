...
## 📌 How to Run
- Open a terminal and navigate to the project root directory: cd "/Users/kavya/Documents/Quiz Application"
- Compile all Java source files: javac src/*/*.java
- Run the quiz application: java -cp src main.QuizGame
